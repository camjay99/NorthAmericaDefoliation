...
if args.cloudstorage:
    ...
    file_name_prefix = f'yearly_max_early_season_evi_{name}/max_early_season_evi_v1_{args.data}'
    image_manifests = {}
assetID = f'projects/{args.project}/assets/yearly_max_early_season_evi_{name}/max_early_season_evi_v1_{args.data}'
description_base = f'{name}_YearlyMaxEarlySeasonEVI_{args.data}'
